...
public class PacmanState {
	 ...
	 private long stateNumber = 0;
		...
		public PacmanState(Game game, MOVE move)
		{
...
//			this.currentLevelTime = game.getCurrentLevelTime();
		...
		public void calIndex(){
			String str = pacmanLivesLeft+""+this.numOfPillsLeft+""+numOfPowerPillsLeft;
			this.stateNumber = Long.valueOf(str);
		}
		
		
		public float calculateReward(){
			return this.blinkyDist+this.inkyDist+this.pinkyDist+this.sueDist;
		}
		
		public PacmanState(String data)
		{
